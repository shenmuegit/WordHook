...
1. 下载 [wordhook-v0.2.0.zip](https://github.com/shenmuegit/WordHook/releases/download/v0.2.0/wordhook-v0.2.0.zip) 并解压
...
然后去任意 HTTPS 网页划任意英文——Hacker News、GitHub、Stack Overflow、技术博客、新闻站，都行。
...
- 注入脚本到任何 HTTPS 页面，仅在你**主动划词**时才向 LLM 发请求
